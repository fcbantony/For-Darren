...
void Level::buildLevelOnePlatforms() {
    ...
    grapplePoints[1].setPosition({ 852, 334 });
    grapplePoints[2].setPosition({ 1230, 117 });
...
void Level::buildLevelTwoPlatforms() {
   ...
   grapplePoints[3].setPosition({ 1010, 220 });
...
void Level::buildLevelThreePlatforms() {
    ...
    grapplePoints[4].setPosition({ 540, 388 });
    grapplePoints[5].setPosition({ 1260, 388 });
